...
string INEGIAPIClient::BuildIndicatorURL(const string &indicator_id, const string &language, const string &geography,
...
nlohmann::json INEGIAPIClient::FetchIndicatorData(const string &indicator_id, const string &language,
                                                  const string &geography, bool recent_only, const string &bank) {
